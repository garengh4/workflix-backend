...
public class ProfileAPI {
    ...
    public ResponseEntity<String> createProfile() throws GeneralException {
        String msg =null;
        return new ResponseEntity<>(msg, HttpStatus.OK);
    }

    @PutMapping(value ="/{userProfileId}/update-profile")
    public ResponseEntity<String> updateProfile(@PathVariable String userProfileId, @RequestBody @Valid ProfileDTO profileDTO) throws GeneralException{
    ...
    public ResponseEntity<String> deleteProfile(@PathVariable String userProfileId) throws GeneralException{
